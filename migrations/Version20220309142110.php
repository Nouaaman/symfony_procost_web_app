 ...
 */
final class Version20220309142110 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE production_times (id INT AUTO_INCREMENT NOT NULL, id_employee_id INT DEFAULT NULL, id_project_id INT DEFAULT NULL, production_time INT NOT NULL, INDEX IDX_7D62ABA94113CAB (id_employee_id), INDEX IDX_7D62ABAB3E79F4B (id_project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
